            ...
            <?php if (count($myBets) > 0) : ?>
                <div class="history history--mybets">
                    ...
                    <table class="history__list">
                        <tr class="history__item history__item--mybets <?php if($myWin) {echo "history__item--win";}?>">
                        ...
                        <?php foreach ($myBets as $bet) : ?>
                            ...
                            ?>
                            <tr class="history__item <?php if($myWin) {echo "history__item--win";}?>">
                                <td class="history__name"><a href="/lot.php?id=<?= $bet['lot_id']; ?>" ><?= $bet['name']; ?></a></td>
