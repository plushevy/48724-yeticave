...
<main>
    ...
    <form class="form form--add-lot container <?= $formErrClass; ?>" action="add.php" method="post"
          enctype="multipart/form-data"> <!-- form--invalid -->
        <h2>Добавление лота</h2>
        <div class="form__container-two">
            <div class="form__item <?php if ($nameErr) {
                echo $itemErrClass;
            } ?>"> <!-- form__item--invalid -->
            ...
            <div class="form__item <?php if ($selectedCategoryErr) {
                echo $itemErrClass;
            } ?>">
        ...
        <div class="form__item form__item--wide <?php if ($messageErr) {
            echo $itemErrClass;
        } ?>">
        ...
        <div class="form__item form__item--file <?php if ($fileErr) {
            echo $itemErrClass;
        } ?>"> <!-- form__item--uploaded -->
        ...
        <div class="form__container-three">
            <div class="form__item form__item--small <?php if ($rateErr) {
                echo $itemErrClass;
            } ?>">
            ...
            <div class="form__item form__item--small <?php if ($stepErr) {
                echo $itemErrClass;
            } ?>">
            ...
            <div class="form__item <?php if ($dateErr) {
                echo $itemErrClass;
            } ?>">
