...
<main>
    ...
    <form class="form container <?= $formErrClass; ?>" action="sign-up.php" method="post" enctype="multipart/form-data">
        <!-- form--invalid -->
        <h2>Регистрация нового аккаунта</h2>
        <div class="form__item <?php if ($emailErr) {
            echo $itemErrClass;
        } ?>"> <!-- form__item--invalid -->
        ...
        <div class="form__item <?php if ($passwordErr) {
            echo $itemErrClass;
        } ?>">
        ...
        <div class="form__item <?php if ($messageErr) {
            echo $itemErrClass;
        } ?>">
        ...
        <div class="form__item form__item--file form__item--last <?php if ($fileErr) {
            echo $itemErrClass;
        } ?>">
            <label>Аватар</label>
            <div class="preview">
